...
const useReduxStore = create<ReduxState>((set) => ({
  count: 0,
...
function App() {
  const [contextTheme, setContextTheme] = React.useState('light')
  const { count: reduxCount, increment: reduxIncrement, decrement: reduxDecrement } = useReduxStore()
    ...
    <div className="chapter-1-app">
      ...
      <div className="comparison-grid">
        ...
        <div className="comparison-card">
          <h2>Redux</h2>
          <div className="card-content">
            <p>计数器: <strong>{reduxCount}</strong></p>
            <div className="button-group">
              <button onClick={reduxIncrement} className="demo-button">+</button>
              <button onClick={reduxDecrement} className="demo-button">-</button>
            </div>
            <div className="pros-cons">
              <h4>优点</h4>
              <ul>
